...
# The public key hash of the (initial) consensus scope owner
OWNER_CONSENSUS ?= 6db01d01e6fe2b770eea422f0323f7425ef727e487a817ac2d752a9a
# The public key hash of the (initial) mercenaries scope owner
OWNER_MERCENARIES ?= 6db01d01e6fe2b770eea422f0323f7425ef727e487a817ac2d752a9a
# The public key hash of the (initial) marketing scope owner
OWNER_MARKETING ?= 70b46e985fa50328fcb3d80594b6c5c54974a08d2c766a47570bfa36

OWNERS := $(OWNER_LEDGER) $(OWNER_CONSENSUS) $(OWNER_MERCENARIES) $(OWNER_MARKETING)
