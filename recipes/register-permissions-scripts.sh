...
show_usage() {
  cat <<EOF Register permissions scripts as stake credentials, for use in withdrawals.
Usage: ${0##*/} [NETWORK]
...
echo -e "\n\033[1mBuild stake credential registrations for all permissions scripts?\033[0m (requires a running cardano-node)" >&2
ask_to_continue
